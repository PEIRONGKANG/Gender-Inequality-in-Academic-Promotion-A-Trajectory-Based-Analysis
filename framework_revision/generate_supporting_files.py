...
write("research_question_mapping.csv",["study","formal_research_question","chapter","former_questions_relocated_to"],[
 ["Overall dissertation","How do gender differences in Japanese academic careers emerge and accumulate through the promotion timeline, institutional mobility, and access to academic resources?","Chapters 1-8","Study 1 locates differences; Study 2 examines organizational movement; Study 3 examines resource accumulation"],
