...
def chapter6(d):
    ...
    h(d,"6.1 Introduction",2); p(d,"Study 3 examines whether access to KAKEN-related academic resources is associated with promotion and whether the association changes across career stages.")
    ...
    h(d,"6.4 Variables and Measures",2); p(d,"Resources are grouped into participation, project leadership, funding, and project-based network position. Primary measures include any KAKEN participation, PI and Co-I roles, direct funding, degree, PI outdegree, and PI indegree. Weighted degree is reserved for robustness analysis.")
    h(d,"6.5 Stage-Specific Analytical Strategy",2); p(d,"Separate model families examine PhD to Associate Professor and Associate Professor to Full Professor. Each uses only resources observed before year t. Gender-by-resource and stage-by-resource terms are introduced selectively; three-way interactions require adequate support.")
    h(d,"6.6 Results: PhD to Associate Professor",2); placeholder(d)
    h(d,"6.7 Results: Associate Professor to Full Professor",2); placeholder(d)
    h(d,"6.8 Gender Differences in Resource Associations",2); placeholder(d,False)
